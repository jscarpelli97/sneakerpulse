    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-dash-border px-4 py-3 sm:px-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="rounded-full border border-dash-border px-2.5 py-1 font-[family-name:var(--font-plex-mono)] text-[10px] uppercase tracking-[0.12em] text-dash-faint">
            {summary.generator === "rules" ? "Rules engine" : "LLM"}
          </span>
        </div>
      </div>
      ...
      <div className="space-y-4 px-4 py-4 sm:px-5">
        ...
        <p className="font-[family-name:var(--font-plex-mono)] text-[11px] leading-relaxed text-dash-faint">
          Generated by SneakerPulse market rules ({summary.ruleId}). Not financial
          advice — swap-ready for an LLM composer later.
        </p>
      </div>
    </section>
  );
